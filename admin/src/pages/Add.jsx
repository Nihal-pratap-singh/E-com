...
const Add = ({ token }) => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      // ✅ FIXED: Use standard Authorization header ✔️
      ...
      console.log(error); // ✅ Add console to debug if needed
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className='w-full'>
        ...
        <textarea onChange={(e) => setDescripation(e.target.value)} value={description} className='w-full max-w-[500px] px-3 py-2' placeholder='Write here' required />
      </div>
      ...
      <div className='flex gap-2'>
        <input
          ...
          onChange={(e) => setBestSeller(e.target.checked ? "true" : "false")}
        />
